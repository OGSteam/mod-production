	...
	function ecrire() {
		...
		for ($i = $start; $i <= $nb_planet; $i++) {
			if ($Planete[$i] == 1) {
				...
				echo "\tif (ratio[" . $i . "] == 1) couleur = 'og-success';\n\telse couleur = 'og-alert';\n";
				// echo "\tif (cases[".$i."] <= ".$user_building[$i]["fields"].") couleur2 = 'lime';\n\telse couleur2 = 'red';\n";
				echo "\tif (cases[" . $i . "] <= " . $binu_fields_used[$i] . ") couleur2 = 'og-success';\n\telse couleur2 = 'og-alert';\n";
				echo "\tdocument.getElementById('fact" . $i . "').innerHTML = '<span class=\'' + couleur + '\'>' + ratio[" . $i . "] + '</span>';\n";
				// echo "\tdocument.getElementById('cases".$i."').innerHTML = '<font color=\'' + couleur2 + '\'>' + format(".$user_building[$i]["fields_used"].") + '</font>';\n";
				echo "\tdocument.getElementById('cases" . $i . "').innerHTML = '<span class=\'' + couleur2 + '\'>' + format(" . $binu_fields_used[$i] . ") + '</span>';\n";
				echo "\tdocument.getElementById('cases_tot" . $i . "').innerHTML = format(" . $user_building[$i]["fields"] . ");\n";
				echo "\tdocument.getElementById('energie" . $i . "').innerHTML = '<span class=\'' + couleur + '\'>' + format(energie[" . $i . "]) + '</span>';\n";
				echo "\tdocument.getElementById('energie_tot" . $i . "').innerHTML = format(energie_tot[" . $i . "]);\n";
				echo "\tdocument.getElementById('prodh_M" . $i . "').innerHTML = '<span class=\'' + couleur + '\'>' + format(metal_heure[" . $i . "]) + '</span>';\n";
				echo "\tdocument.getElementById('prodh_C" . $i . "').innerHTML = '<span class=\'' + couleur + '\'>' + format(cristal_heure[" . $i . "]) + '</span>';\n";
				echo "\tdocument.getElementById('prodh_D" . $i . "').innerHTML = '<span class=\'' + couleur + '\'>' + format(deut_heure[" . $i . "]) + '</span>';\n";
				echo "\tdocument.getElementById('prodj_M" . $i . "').innerHTML = '<span class=\'' + couleur + '\'>' + format(24 * metal_heure[" . $i . "]) + '</span>';\n";
				echo "\tdocument.getElementById('prodj_C" . $i . "').innerHTML = '<span class=\'' + couleur + '\'>' + format(24 * cristal_heure[" . $i . "]) + '</span>';\n";
				echo "\tdocument.getElementById('prodj_D" . $i . "').innerHTML = '<span class=\'' + couleur + '\'>' + format(24 * deut_heure[" . $i . "]) + '</span>';\n";
...
<div class="ogspy-mod-header">
	<h2><?php echo $lang['prod_uction_mod']; ?></h2>
</div>
...
<form name="Save" method="post" action="">
	...
	<table class="og-table og-full-table" id="simu">
		<thead>
			<tr>
				<th colspan="<?php echo $nb_planete_reel + 1; ?>">
					<input class="og-button" type='submit' value='<?php echo $lang['prod_save']; ?>' onClick='javascript:verif_donnee(1)'>&nbsp;<input class="og-button" ttype='submit' value='<?php echo $lang['prod_reset']; ?>' onClick="javascript:chargement()">
				</th>
			</tr>
			<tr>
				<th>
					<?php echo $lang['prod_planete']; ?>
				</th>
				<?php for ($i = $start; $i <= $nb_planet; $i++) : ?>
					<th>
						<?php $name[$i] = ($user_building[$i]["planet_name"] == "") ? "&nbsp;" : $user_building[$i]["planet_name"]; ?>
						<?php echo $name[$i]; ?>
					</th>
				<?php endfor; ?>
			</tr>
		...
		<tbody>
			<tr>
				<td class="tdname">
					<?php echo $lang['prod_coordinates']; ?>
				</td>
				<?php for ($i = $start; $i <= $nb_planet; $i++) : ?>
					<td class="tdcontent">
			...
			<tr>
				<td class="tdname">
					<?php echo $lang['prod_temperature']; ?> <!--//Température maximale-->
				</td>
				<?php for ($i = $start; $i <= $nb_planet; $i++) : ?>
					<td class="tdcontent">
						<?php $temperature_max = ($user_building[$i]["temperature_max"] == "") ? "&nbsp;" : $user_building[$i]["temperature_max"]; ?>
						<?php echo $temperature_max; ?>
					</td>
				<?php endfor; ?>
			</tr>
			<tr>
				<td class="tdname">
					<?php echo $lang['prod_fields']; ?> <!--Cases-->
				</td>
				<?php for ($i = $start; $i <= $nb_planet; $i++) : ?>
					<td class="tdcontent">
						<?php $fields = ($user_building[$i]["fields"] == "0") ? "?" : $user_building[$i]["fields"]; ?>
						<?php $fields_used =  $user_building[$i]["fields_used"]; ?>
						<span id='cases<?php echo $i; ?>'><span class="og-success"><?php echo $fields; ?> </span> </span>/
						<span id='cases_tot<?php echo $i; ?>'><span class="og-success"><?php echo $fields_used; ?></span> </span>
					</td>
				<?php endfor; ?>
			</tr>
			<tr>
				<td class="tdname">
					<?php echo $lang['prod_energy']; ?> <!--Énergie-->
				</td>
				<?php for ($i = $start; $i <= $nb_planet; $i++) : ?>
					<td class="tdcontent">
						<span id='energie<?php echo $i; ?>'></span>/
						<span id='energie_tot<?php echo $i; ?>'></span>
		...
		<thead>
			<tr>
				<th colspan="<?php echo $nb_planete_reel  + 1; ?>">
					<?php echo $lang['prod_buildings']; ?>
				</th>
			</tr>
		</thead>
		<tbody>
			<?php for ($b = 1; $b <= 5; $b++) : ?><!--Batiment-->
				<tr>
					<td class="tdname">
						<?php echo $lang['prod_building_' . $bati[$b]]; ?>
					</td>
					<?php for ($i = $start; $i <= $nb_planet; $i++) : ?>
						<td class="tdcontent">
							<a style='cursor: pointer; vertical-align: middle;' onClick='javascript:add(<?php echo  $b; ?>,<?php echo $i; ?>,-1)'>-</a>
							<input type='text' id='<?php echo $bati[$b] . $i; ?>' name='<?php echo $bati[$b] . $i; ?>' size='2' maxlength='2' onBlur='javascript:verif_donnee(0)' value='0'>
							<a style='cursor: pointer; vertical-align: middle;' onClick='javascript:add(<?php echo  $b; ?>,<?php echo $i; ?>,1)'>+</a>
							<select id='rap_<?php echo $bati[$b] . $i; ?>' name='rap_<?php echo $bati[$b] . $i; ?>' onChange='javascript:verif_donnee(0)'>
			...
			<tr>
				<td class="tdname">
					<?php echo $lang['prod_SS']; ?>
				</td>
				<?php for ($i = $start; $i <= $nb_planet; $i++) : ?>
					<td class="tdcontent">
						<a style='cursor: pointer; vertical-align: middle;' onClick='javascript:add(6,<?php echo $i; ?>,-1)'>-</a>
						<input type='text' id='<?php echo $bati[6] . $i; ?>' name='<?php echo $bati[6] . $i; ?>' size='2' maxlength='6' onBlur='javascript:verif_donnee(0)' value='0'>
						<input type='hidden' name='planete<?php echo $i; ?>' value='<?php echo $Planete[$i]; ?>'>
						<a style='cursor: pointer; vertical-align: middle;' onClick='javascript:add(6,<?php echo $i; ?>,1)'>+</a>
						<select id='rap_<?php echo $bati[6] . $i; ?>' name='rap_<?php echo $bati[6] . $i; ?>' onChange='javascript:verif_donnee(0)'>
							<?php for ($j = 100; $j >= 0; $j = $j - 10) : ?>
								<option value='<?php echo $j; ?>'>
									<?php echo $j; ?>%
								</option>
			...
			<tr>
				<td class="tdname">
					<?php echo $lang['prod_FO']; ?>
				</td>
				<?php for ($i = $start; $i <= $nb_planet; $i++) : ?>
					<td class="tdcontent">
						<a style='cursor: pointer; vertical-align: middle;' onClick='javascript:add(7,<?php echo $i; ?>,-1)'>-</a>
						<input type='text' id='<?php echo $bati[7] . $i; ?>' name='<?php echo $bati[7] . $i; ?>' size='2' maxlength='6' onBlur='javascript:verif_donnee(0)' value='0'>
						<input type='hidden' name='planete<?php echo $i; ?>' value='<?php echo $Planete[$i]; ?>'>
						<a style='cursor: pointer; vertical-align: middle;' onClick='javascript:add(7,<?php echo $i; ?>,1)'>+</a>
						<select id='rap_<?php echo $bati[7] . $i; ?>' name='rap_<?php echo $bati[7] . $i; ?>' onChange='javascript:verif_donnee(0)'>
							<?php $startingCollect = ($class_collect == 1) ? 150 : 100; ?>
							<?php for ($j = $startingCollect; $j >= 0; $j = $j - 10) : ?>
								<option value='<?php echo $j; ?>'>
									<?php echo $j; ?>%
								</option>
							<?php endfor; ?>
		...
		<tbody>
			<tr>
				<td class="tdname">
					<?php echo $lang['prod_technology_En']; ?>
				</td>
				<td class="tdcontent">
					<a style='cursor: pointer;vertical-align: middle;' onClick='javascript:add(8,0,-1)'>-</a>
					<input type='text' id='techno_energie' name='techno_energie' size='2' maxlength='6' onBlur='javascript:verif_donnee(0)' value='0'>
					<a style='cursor: pointer;vertical-align: middle;' onClick='javascript:add (8,0,1)'>+</a>
				</td>
				<td class="tdname">
					<?php echo $lang['prod_technology_Pl']; ?>
				</td>
				<td class="tdcontent">
					<a style='cursor: pointer;vertical-align: middle;' onClick='javascript:add (9,0,-1)'>-</a>
					<input type='text' id='techno_plasma' name='techno_plasma' size='2' maxlength='6' onBlur='javascript:verif_donnee(0)' value='0'>
					<a style='cursor: pointer;vertical-align: middle;' onClick='javascript:add (9,0,1)'>+</a>
				</td>
				<td class="tdname" colspan="2" title="<?php echo $lang['prod_officer_E_help']; ?>">
					<label>
						<?php echo $lang['prod_officer_E']; ?>
						<input type='checkbox' id='c_off_ingenieur' name='c_off_ingenieur' onClick='javascript:verif_donnee(0)'>
					</label>
				</td>
				<td class="tdname" colspan="2" title="<?php echo $lang['prod_officer_G_help']; ?>">
					<label>
						<?php echo $lang['prod_officer_G']; ?>
						<input type='checkbox' id='c_off_geologue' name='c_off_geologue' onClick='javascript:verif_donnee(0)'>
					</label>
				</td>
				<td class="tdname" colspan="2" title="<?php echo $lang['prod_officer_full_help']; ?>">
					<label>
						<?php echo $lang['prod_officer_full']; ?>
						<input type='checkbox' id='c_off_full' name='c_off_full' onClick='javascript:verif_donnee(0)'>
					</label>
				</td>
				<td class="tdname" colspan="2" title="<?php echo $lang['prod_collect_help']; ?>">
					<label>
						<?php echo $lang['prod_collect']; ?>
						<input type='checkbox' id='c_class_collect' name='c_class_collect' onClick='javascript:verif_donnee(0)'>
					</label>
				</td>
			</tr>
		</tbody>
		<thead>
			<tr>
				<th colspan="<?php echo $nb_planete_reel + 1; ?>">
					<?php echo $lang['prod_prod_factor']; ?>
				</th>
			</tr>
		</thead>
		<tbody>
		...
		<tbody>
			<?php for ($b = 1; $b <= 3; $b++) : ?>
				<tr>
					...
					<?php for ($i = $start; $i <= $nb_planet; $i++) : ?>
						<td class="tdcontent">
							<span id='prodh_<?php echo $bati[$b] . $i; ?>'></span>
						</td>
					<?php endfor; ?>
				</tr>
			<?php endfor; ?>
		...
		<tbody>
			<?php for ($b = 1; $b <= 3; $b++) : ?>
				<tr>
					...
					<?php for ($i = $start; $i <= $nb_planet; $i++) : ?>
						<td class="tdcontent">
							<span id='prodj_<?php echo $bati[$b] . $i; ?>'></span>
						</td>
					<?php endfor; ?>
				</tr>
			<?php endfor; ?>
		...
		<tbody>
			<tr>
				<td class="tdname">
					<a style='cursor: pointer;vertical-align: middle;' onClick='javascript:selection(0)' title='<?php echo $lang['prod_none']; ?>'>-</a>
					<?php echo $lang['prod_account']; ?>
					<a style='cursor: pointer;vertical-align: middle;' onClick='javascript:selection(1)' title='<?php echo $lang['prod_all']; ?>'>+</a>
				</td>
				<?php for ($i = $start; $i <= $nb_planet; $i++) : ?>
					<?php $j = $i - $start + 1; ?>
					<?php $checkbox = (($Planete[$i] == 1)) ? "checkbox" : "hidden"; ?>
					<td class="tdcontent">
						<label>
							<input type='<?php echo $checkbox; ?>' id='global<?php echo $j; ?>' name='global<?php echo $j; ?>' onClick='javascript:verif_donnee(0)'>&nbsp;<?php echo $name[$i]; ?></label>
					</td>
				<?php endfor; ?>
			</tr>
			<tr>
				<td class="tdname">
					<?php echo $lang['prod_hour']; ?>
				</td>
				<td class="tdname">
					<?php echo $lang['prod_M']; ?>
				</td>
				<td class="tdcontent">
					<span class="og-highlight" id='prodh_mtot'></span>
					</th>
				<td class="tdname">
					<?php echo $lang['prod_C']; ?></a></th>
				<td class="tdcontent">
					<span class="og-highlight" id='prodh_ctot'></span>
					</th>
				<td class="tdname">
					<?php echo $lang['prod_D']; ?>
				</td>
				<td class="tdcontent">
					<span class="og-highlight" id='prodh_dtot'></span>
				</td>
				<td class="tdname">
					<?php echo $lang['prod_points']; ?>
				</td>
				<td class="tdcontent">
					<span class="og-highlight" id='prodh_ptot'></span>
				</td>
				<td class="tdname">
					<?php echo $lang['prod_hour']; ?>
				</td>
			...
			<tr>
				...
				<td class="tdcontent">
					<span class="og-highlight" id='prodj_mtot'></span>
					</th>
				<td class="tdname">
					<?php echo $lang['prod_C']; ?></a></th>
				<td class="tdcontent">
					<span class="og-highlight" id='prodj_ctot'></span>
					</th>
				<td class="tdname">
					<?php echo $lang['prod_D']; ?>
				</td>
				<td class="tdcontent">
					<span class="og-highlight" id='prodj_dtot'></span>
				</td>
				<td class="tdname">
					<?php echo $lang['prod_points']; ?>
				</td>
				<td class="tdcontent">
					<span class="og-highlight" id='prodj_ptot'></span>
				</td>
				<td class="tdname">
					<?php echo $lang['prod_day']; ?>
				</td>
			</tr>
			<tr>
				...
				<td class="tdcontent">
					<span class="og-highlight" id='prods_mtot'></span>
					</th>
				<td class="tdname">
					<?php echo $lang['prod_C']; ?></a></th>
				<td class="tdcontent">
					<span class="og-highlight" id='prods_ctot'></span>
					</th>
				<td class="tdname">
					<?php echo $lang['prod_D']; ?>
				</td>
				<td class="tdcontent">
					<span class="og-highlight" id='prods_dtot'></span>
				</td>
				<td class="tdname">
					<?php echo $lang['prod_points']; ?>
				</td>
				<td class="tdcontent">
					<span class="og-highlight" id='prods_ptot'></span>
				</td>
				<td class="tdname">
					<?php echo $lang['prod_week']; ?>
				</td>
			</tr>
			<tr>
				<td class="tdname">
					<?php echo $lang['prod_ratio']; ?>
				</td>
				<td class="tdname" onClick="javascript:func_rapport(3)" title="<?php echo $lang['prod_ref']; ?>">
					<img style="cursor: help;" src="images/help_2.png" alt="?">
					<?php echo $lang['prod_M']; ?>
				</td>
				<td class="tdcontent" onClick="javascript:func_rapport(3)" title="<?php echo $lang['prod_ref']; ?>">
					<span class="og-highlight" id='rapport_m'></span>
					</th>
				<td class="tdname" onClick="javascript:func_rapport(2)" title="<?php echo $lang['prod_ref']; ?>">
					<img style="cursor: help;" src="images/help_2.png" alt="?">
					<?php echo $lang['prod_C']; ?>
				</td>
				<td class="tdcontent" onClick="javascript:func_rapport(2)" title="<?php echo $lang['prod_ref']; ?>">
					<span class="og-highlight" id='rapport_c'></span>
				</td>
				<td class="tdname" onClick="javascript:func_rapport(1)" title="<?php echo $lang['prod_ref']; ?>">
					<img style="cursor: help;" src="images/help_2.png" alt="?"> <?php echo $lang['prod_D']; ?>
				</td>
				<td class="tdcontent" onClick="javascript:func_rapport(1)" title="<?php echo $lang['prod_ref']; ?>">
					<span class="og-highlight" id='rapport_d'></span>
				</td>
			</tr>
		</tbody>
	</table>
